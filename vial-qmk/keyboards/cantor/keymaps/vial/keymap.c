...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] =  LAYOUT_split_3x6_3(
      ...
      OSM(KC_LSFT),  KC_Z,    KC_X,    KC_V,    KC_C,    KC_B,                        KC_H,    KC_D,    KC_Y,    KC_J,     KC_K,    KC_CIRC,
    ...
    [1] = LAYOUT_split_3x6_3(
      ...
      OSM(KC_LSFT),  KC_HASH,  KC_RABK,  KC_RCBR,  KC_RPRN,  KC_RBRC,                     KC_CIRC,  KC_AT,    KC_DLR,   XXXXXXX,  XXXXXXX,  XXXXXXX,
    ...
    [2] = LAYOUT_split_3x6_3(
      ...
      OSM(KC_LSFT),  KC_UNDO,  KC_CUT,   KC_COPY,  KC_PSTE,  XXXXXXX,                     XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
