...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] =  LAYOUT_split_3x6_3(
      ...
      OSM(KC_LCTL),  KC_Z,    KC_X,    KC_V,    KC_C,    KC_B,                        KC_H,    KC_D,    KC_Y,    KC_J,     KC_K,    KC_CIRC,
    ...
    [1] = LAYOUT_split_3x6_3(
      ...
      OSM(KC_LCTL),  KC_HASH,  KC_RABK,  KC_RCBR,  KC_RPRN,  KC_RBRC,                     KC_CIRC,  KC_AT,    KC_DLR,   XXXXXXX,  XXXXXXX,  XXXXXXX,
    ...
    [2] = LAYOUT_split_3x6_3(
      ...
      OSM(KC_LCTL),  KC_UNDO,  KC_CUT,   KC_COPY,  KC_PSTE,  XXXXXXX,                     XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    ...
    [3] = LAYOUT_split_3x6_3(
      ...
      OSM(KC_LCTL), XXXXXXX,  KC_F1,  KC_F2,  KC_F3,  KC_F12,                     KC_0,    KC_1,  KC_2,  KC_3,  KC_ASTR,  KC_ENT,
